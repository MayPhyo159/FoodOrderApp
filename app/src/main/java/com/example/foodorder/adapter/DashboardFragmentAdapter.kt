...
import com.example.foodorder.activity.RestaurantMenuActivity
...
class DashboardFragmentAdapter(val context: Context, var itemList: ArrayList<Restaurant>) :
    ...
    override fun onBindViewHolder(holder: ViewHolderDashboard, position: Int) {
        ...
        Picasso.get().load(restaurant.restaurantImage).error(R.drawable.ic_baseline_restaurant_24)
        ...
        holder.txtFavorite.setOnClickListener {
            if (!DBAsyncTask(context, restaurantEntity, 1).execute().get()) {
                ...
                if (result) {
                    ...
                    holder.txtFavorite.background = context.resources.getDrawable(R.drawable.ic_favourite_full)
                ...
                if (result) {
                    ...
                    holder.txtFavorite.background = context.resources.getDrawable(R.drawable.ic_favourite_empty)
